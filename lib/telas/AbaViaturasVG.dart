...
class AbaViaturasVG extends StatefulWidget {
  const AbaViaturasVG({Key? key}) : super(key: key);
  @override
  _AbaViaturasVGState createState() => _AbaViaturasVGState();
}

class _AbaViaturasVGState extends State<AbaViaturasVG> {
            ...
            return ListView.builder(
              ...
              itemBuilder: (_, index) {
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, "/dadosviaturasVG",
                        arguments: viatura);
                  },
                  child: Card(
                    elevation: 8,
