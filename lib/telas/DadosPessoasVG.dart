...
class DadosPessoasVG extends StatefulWidget {

  Pessoa pessoa;
  DadosPessoasVG(this.pessoa);

  @override
  State<DadosPessoasVG> createState() => _DadosPessoasVGState();
}
...
class _DadosPessoasVGState extends State<DadosPessoasVG> {
